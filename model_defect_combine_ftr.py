...
class DefectNetCombine(nn.Module):
    def __init__(self, args, num_ftr):
        super(DefectNetCombine, self).__init__()
        self.args = args
        ...
        self.fc1 = nn.Linear(2 * len(Ks) * Co + self.num_ftr, args.hidden_units)  # hidden units
    ...
    def forward(self, msg, code, num_ftr):
        ...
        x_commit = torch.cat((x_msg, x_code, num_ftr), 1)
